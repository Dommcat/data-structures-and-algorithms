...
// console.log(replaceZeros('number is 0'))
...
const validateWord = (word) => {
  // Solution code here...
  let wordDigits = /^[a-zA-Z]{5,10}$/;
  return wordDigits.test(word);
};
...
const hasNumber = (string) => {
  // Solution code here...
  let stringPattern = /[a-zA-Z]+\d+/;
  return stringPattern.test(string);
};
// console.log(hasNumber('this has a number'));
...
// console.log(validateEmail('this is valid email'));
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  let validNumber = /^(?:\(\d{3}\)|\d{3}-)\d{3}-\d{4}$/;
  return validNumber.test(phoneNumber);
};
