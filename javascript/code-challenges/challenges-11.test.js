...
const count = (target, input) => {
  // Solution code here...
  return input.reduce((acc, subarr) => acc + subarr.filter(element => element === target).length, 0);
  // console.log(5, [[1, 3, 5, 7, 9], [], [5, 5, 5], [1, 2, 3], []]);
};
...
const totalSum = (input) => {
  // Solution code here...\
  return input.reduce((total, subinput) => {
    return total + subinput.reduce((subTotal, element) => {
