...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(function (element) {
    console.log(element, 'this is the 5th element');
...
const addQuestion = (arr) => {
  ...
  let newArr = [];
  arr.map(function (element) {
    // console.log(element, 'this is the element for test challenge 3');
    newArr.push(element + '?');
...
that produces the same output as your forLoopTwoToThe function from challenge 4 and your forEachTwoToThe function from challenge 5, but uses map instead of a for loop or forEach.
------------------------------------------------------------------------------------------------ */
